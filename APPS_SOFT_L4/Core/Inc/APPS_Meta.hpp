...
const int APPS_1_RAW_MIN = 1601;
const int APPS_1_RAW_MAX = 3500;
static_assert(APPS_1_RAW_MIN < APPS_1_RAW_MAX);
const int APPS_1_RAW_FULLSCALE = APPS_1_RAW_MAX - APPS_1_RAW_MIN;
const int APPS_1_OFFSETTED_MIN = std::round( APPS_1_RAW_FULLSCALE * apps_dead_zone + APPS_1_RAW_MIN );

// const for apps sensor 2
const int APPS_2_RAW_MIN = 1950;
const int APPS_2_RAW_MAX = 3900;
static_assert(APPS_2_RAW_MIN < APPS_2_RAW_MAX);
const int APPS_2_RAW_FULLSCALE = APPS_2_RAW_MAX - APPS_2_RAW_MIN;
const int APPS_2_OFFSETTED_MIN = std::round( APPS_2_RAW_FULLSCALE * apps_dead_zone + APPS_2_RAW_MIN);
